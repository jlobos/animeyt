...
** 									 "pg" por "p". Esto sólo ocurre en la versión 1.4. Gracias a jean pierre m. por
**									 reportar el bug.
...
if (@!$_pagi_htaccess){
	 ...
	 */
	 ...
	 if ($_pagi_actual != 1){
		...
		$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."p=".$_pagi_url."'>$_pagi_nav_anterior</a>";	 }
	 ...
	 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
		if ($_pagi_i == $_pagi_actual) {
			...
			$_pagi_navegacion_temporal[] = "<span class=".$_pagi_nav_estilo_actual.">$_pagi_i</span>";
		}else{
			// Si es cualquier otro. Se escibe el enlace a dicho número de página.
			$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."p=".$_pagi_i."'>".$_pagi_i."</a>";
		}
	 }
	 ...
	 if ($_pagi_actual < $_pagi_totalPags){
		...
		$_pagi_url = $_pagi_actual + 1; //será el número de página al que enlazamos
		$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."p=".$_pagi_url."'>$_pagi_nav_siguiente</a>";
	 }
